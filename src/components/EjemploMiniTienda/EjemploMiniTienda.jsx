    ...
    <main className="bg-gray-50 min-h-screen">
      ...
      <section className="py-12 px-4 bg-white" data-aos="fade-down">
        <div className="max-w-4xl mx-auto">
          <Swiper modules={[Autoplay, Pagination]} spaceBetween={30} pagination={{ clickable: true }} autoplay={{ delay: 3000 }}>
            <SwiperSlide>
              <img src="https://images.pexels.com/photos/267394/pexels-photo-267394.jpeg" alt="Oferta 1" className="rounded-xl" />
            </SwiperSlide>
            <SwiperSlide>
              <img src="https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg" alt="Producto Destacado" className="rounded-xl" />
            </SwiperSlide>
          </Swiper>
        </div>
      </section>
            ...
            {productosFiltrados.map((producto, index) => (
              <div key={index} className="bg-white rounded-xl shadow hover:shadow-md transition overflow-hidden" data-aos="fade-up">
                ...
                <div className="p-5">
                  ...
                  <a href={`https://wa.me/56912345678?text=${encodeURIComponent(`Hola! Quiero comprar ${producto.nombre}. ¿Está disponible?`)}`} target="_blank" rel="noopener noreferrer" className="inline-block bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium">
      ...
      <section className="mt-10 max-w-2xl mx-auto text-center" data-aos="fade-up">
        ...
        <iframe className="w-full h-64 rounded-lg" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7912.055681132748!2d-70.60753603465253!3d-33.51153219293432!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9662d06e6c71db0d%3A0xdfdf70523ce83fbb!2sCenco%20Florida!5e0!3m2!1ses-419!2scl!4v1749741645999!5m2!1ses-419!2scl" allowFullScreen loading="lazy" />
      </section>
