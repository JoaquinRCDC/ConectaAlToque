...
export default function App() {
  ...
  const jsonLd = [
    {
      ...
      "@type": "Organization",
      name: "Conecta Al Toque",
      url: "https://conectaaltoque.cl",
      logo: "https://conectaaltoque.cl/logo.png",
    },
    {
      "@context": "https://schema.org",
      "@type": "WebSite",
      ...
      potentialAction: {
        "@type": "SearchAction",
        target: "https://conectaaltoque.cl/buscar?q={search_term_string}",
  ...
  return (
    <>
      {/* --------- SEO (Home) --------- */}
      <Helmet>
        <title>Conecta Al Toque — Sitios web que venden</title>
        <meta
          name="description"
          content="Sitios modernos, rápidos y listos para vender. Soporte local en Chile, entrega ágil y planes para emprendedores."
        />
        <link rel="canonical" href="https://conectaaltoque.cl/" />

        {/* OG/Twitter */}
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Conecta Al Toque" />
        <meta property="og:title" content="Conecta Al Toque — Sitios web que venden" />
        <meta
          property="og:description"
          content="Sitios modernos, rápidos y listos para vender. Soporte local en Chile."
        />
        <meta property="og:url" content="https://conectaaltoque.cl/" />
        <meta property="og:image" content="https://conectaaltoque.cl/og-cover.jpg" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Conecta Al Toque — Sitios web que venden" />
        <meta
          name="twitter:description"
          content="Sitios modernos, rápidos y listos para vender. Soporte local en Chile."
        />
        <meta name="twitter:image" content="https://conectaaltoque.cl/og-cover.jpg" />
...
/>
      ...
      <div className="font-sans text-gray-800 antialiased" data-aos="fade-up">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="mt-4 text-lg opacity-90">
                Diseñamos sitios modernos, rápidos y listos para vender. Tú te enfocas en tu negocio,
                nosotros en tu web.
              </p>
              ...
              <div className="bg-blue-50 p-7 rounded-2xl border border-blue-200">
                ...
                <div className="mt-5 grid grid-cols-3 gap-3 text-sm">
                  {["Rápido", "Seguro", "Escalable"].map((k, i) => (
                    <div
                      key={i}
                      className="bg-white/80 rounded-lg px-3 py-2 text-center border border-blue-100"
                    >
                      {k}
                    </div>
                  ))}
        ...
        {/* Modelos (usa <Link> para navegación interna) */}
        <section className="py-16 px-4 bg-gray-50" data-aos="fade-up" id="servicios">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-[1.02] hover:shadow-lg">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 mb-4">
                      Presentación profesional con llamados a la acción claros.
                    </p>
              ...
              {/* Ejemplo Corporativo */}
              <Link to="/ejemplo-corporativo" className="block">
                <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-[1.02] hover:shadow-lg">
                  <div className="h-48 overflow-hidden">
                    <img
                      src={ejemplominitienda}
                      alt="Preview Sitio Corporativo"
                      className="w-full h-full object-cover"
                      loading="lazy"
                      decoding="async"
                    />
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 mb-4">
                      Hasta 5 secciones, formulario avanzado e integración con redes.
                    </p>
              ...
              <Link to="/ejemplo-tienda-online" className="block">
                <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-[1.02] hover:shadow-lg">
                  <div className="h-48 overflow-hidden">
                    <img
                      src={EjemploTiendaFull}
                      alt="Preview Tienda Online"
                      className="w-full h-full object-cover"
                      loading="lazy"
                      decoding="async"
                    />
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 mb-4">
                      Catálogo dinámico, carrito + WebPay y gestión básica de inventario.
                    </p>
        ...
        <section id="comparacion" className="py-16 px-4 bg-white" data-aos="fade-up">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-xs text-gray-500 mt-4 text-center">
              *Los precios son <b>desde</b> y pueden variar según el alcance. El primer año incluye
              mantención <b>Básica</b>; desde el segundo año se renueva según el plan. Integraciones y
              funciones extra se cotizan aparte.
            </p>
          </div>
        </section>
            ...
            <div className="grid gap-8 md:grid-cols-3">
                ...
                <div className="p-8 pt-0">
                  <a
                    href={`https://wa.me/56929240183?text=${encodeURIComponent(
                      "Hola! Quiero cotizar la Landing Page de Conecta al Toque."
                    )}`}
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <div className="group relative flex flex-col rounded-2xl bg-white shadow-[0_12px_36px_rgba(76,72,255,.15)] ring-2 ring-indigo-400 hover:shadow-[0_18px_48px_rgba(76,72,255,.22)] transition-all duration-300 md:-translate-y-1.5">
                ...
                <div className="p-8 pt-0">
                  <a
                    href={`https://wa.me/56929240183?text=${encodeURIComponent(
                      "Hola! Quiero cotizar un Sitio Corporativo con Conecta al Toque."
                    )}`}
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <div className="group relative flex flex-col rounded-2xl bg-white shadow-[0_10px_30px_rgba(0,0,0,.06)] ring-1 ring-gray-200 hover:shadow-[0_16px_40px_rgba(0,0,0,.10)] transition-all duration-300">
                ...
                <div className="p-8 pt-0">
                  <a
                    href={`https://wa.me/56929240183?text=${encodeURIComponent(
                      "Hola! Estoy interesado en la Tienda Online de Conecta al Toque."
                    )}`}
                    target="_blank"
                    rel="noopener noreferrer"
        ...
        <section className="py-16 px-4 bg-white" data-aos="fade-up">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-xs text-gray-500 mt-6 text-center">
              *No incluye desarrollos de nuevas secciones/funcionalidades. Si el uso crece y requiere más
              recursos de terceros, te avisamos antes para proponer upgrade.
            </p>
          </div>
        </section>
        ...
        <section
          id="contacto"
          className="py-20 px-4 bg-gradient-to-r from-teal-600 to-blue-700 text-white text-center"
        >
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link to="/ejemplo-landing" className="hover:text-white transition">
                    Landing Pages
                  </Link>
                </li>
                <li>
                  <Link to="/ejemplo-corporativo" className="hover:text-white transition">
                    Sitio corporativo
                  </Link>
                </li>
                <li>
                  <Link to="/ejemplo-tienda-online" className="hover:text-white transition">
                    Tienda online
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                {/* Reemplaza estos # cuando tengas URLs reales para evitar warnings */}
                <li>
                  <a href="#" className="hover:text-white transition" aria-disabled="true">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex space-x-4 mt-4">
                  {/* Elimina # si aún no tienes redes para evitar penalizaciones */}
                  <a href="#" className="hover:text-white transition" aria-disabled="true">
                    FB
                  </a>
                  <a href="#" className="hover:text-white transition" aria-disabled="true">
